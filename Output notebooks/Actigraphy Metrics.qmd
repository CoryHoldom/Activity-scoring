...
agged = aggregate(Data_raw_walk[c("userAcceleration_X", "userAcceleration_Y", "userAcceleration_Z", "userAcceleration_VM")], Data_raw_walk["bin"], FUN = var)

agged$new_VM = (agged$userAcceleration_X^2 + agged$userAcceleration_Y^2 + agged$userAcceleration_Z^2)

plot(x = agged$bin, y = agged$userAcceleration_X, type = "l")
...
ggplot() +
  theme_bw() +
  geom_histogram(data = agged, aes(x = userAcceleration_VM+0.0001)) +
  scale_x_log10()
